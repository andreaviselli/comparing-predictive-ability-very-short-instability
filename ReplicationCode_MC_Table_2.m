...
%   the empirical power of several tests for equal predictive ability. The
%   simulation is designed to replicate the power analysis (Table 2) from
...
%      is introduced only in the last 'm' observations of the sample.
%   2. Constant and End-of-Sample Instability ("const+end"): A constant
%      mean shift of 'mu' is present throughout the sample, and an
%      additional break of magnitude 'delta' is introduced in the last 'm'
%      observations.
%
%   The simulation iterates over a grid of values for 'mu' and 'delta' to
%   trace out the power function of each test against different types and
...
fprintf("Table 2: Results for the MC with phi=0, sigma2=1.8, T=80, m=1.\n")
disp(res)